...
delete_texto = [
    "+ APOS SOLICITAR", "E APÓS SOLICITAR", "E APOS SOLICITAR", "APOS SOLICITAR", "APÓS SOLICITAR", "APOSSOLICITAR", "APOS, SOLICITAR PARECER", "APOS,SOLICITAR", "APOS. SOLICITAR", "APOS.SOLICITAR",  "E APOS, SOLICITAR", "E SOLICITAR O PARECER" "CASO NAO POSSUA, SOLICITAR", "CASO POSSUA, SOLICITAR", "+ APOS, SOLICITAR", "+APOS SOLICITAR", "+APOS, SOLICITAR", " + APOS, SOLICITAR", "PARECER DO", "PARECER DA", "PARECER PARA", "E CONTRATO DE ADESAO AO PLANO" "CONTRATO DE ADESAO AO PLANO", "PEDIR PARECER", "PEDIR O PARECER"
]

questiona_texto = ["CHECAR", "VERIFICAR", "SE REALIZOU", "REALIZOU", "SOLICITAR PARECER" "SE POSSUI", "POSSUI", "SE BF", "CHECAR SE", "VERIFICAR SE", "GM", "LESALES", "ITM"]
...
block_questionamento = ["ANEXAR", "TROCAR", "SOLICITAR"]
